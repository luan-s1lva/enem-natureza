...
@section('content')
<header>
    <h1 class="text-center fundo2 container-fluid-md col-md">Ranking Semanal</h1>
</header>
    ...
    <section>
        <div class="row row-cols-3" style="background-color:white; height:95px;">
            <div class="col-2">
                ...
                <div style="float:left;">
                    <p style="margin-top: 1.6em; font-size:21px; font-style:italic; font-weight: 900;">5º</p>
                </div>
    ...
    <section>
        <div class="row row-cols-3" style="background-color:white; height:95px;">
            <div class="col-2">
                ...
                <div style="float:left;">
                    <p style="margin-top: 1.6em; font-size:21px; font-style:italic; font-weight: 900;">6º</p>
                </div>
